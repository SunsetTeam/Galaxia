package galaxia.world.blocks.power;
...
import arc.struct.*;
import arc.util.*;
import galaxia.content.GalFx;
import galaxia.world.meta.GalStat;
import galaxia.world.meta.GalStatUnit;
import mindustry.*;
...
public class LightningPowerNode extends PowerNode {
    ...
    public void setStats() {
        ...
        aStats.add(GalStat.lightningDiff, thresholdPerTile * Vars.tilesize, GalStatUnit.powerBlock);
    }
        ...
        public void update() {
            ...
            if(!nodes.isEmpty()) {
                ...
                for(LightningPowerNodeBuild node : nodes) {
                    ...
                    GalFx.lightning(x, y, node.x, node.y, lightningColor, 3, 12f, lightningFx);
